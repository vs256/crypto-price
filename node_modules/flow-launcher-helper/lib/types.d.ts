type PrependFlowLauncher<Method> = Method extends string ? `Flow.Launcher.${Method}` : never;
type FlowLauncherInternMethods = PrependFlowLauncher<'ChangeQuery' | 'RestartApp' | 'SaveAppAllSettings' | 'CheckForNewUpdate' | 'ShellRun' | 'CloseApp' | 'HideApp' | 'ShowApp' | 'ShowMsg' | 'GetTranslation' | 'OpenSettingDialog' | 'GetAllPlugins' | 'StartLoadingBar' | 'StopLoadingBar' | 'ReloadAllPluginData' | 'CopyToClipboard'>;
